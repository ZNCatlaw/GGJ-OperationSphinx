...
public static partial class Commands
{
	...
	{
		return TintTo(gameObject.renderer.material, endColour, duration, ease);
	}
	...
	{
		return TintBy(gameObject.renderer.material, offset, duration, ease);
	}
	...
	{
		return TintFrom(gameObject.renderer.material, startColour, duration, ease);
	}
	...
	{
		return AlphaTo(gameObject.renderer.material, endAlpha, duration, ease);
	}
	...
	{
		return AlphaBy(gameObject.renderer.material, offset, duration, ease);
	}
	...
	{
		return AlphaFrom(gameObject.renderer.material, startAlpha, duration, ease);
	}
